...
<nav class="navbar navbar-fixed-top" style="background-color: #ee7614;">
  <div class="container-fluid " style="position: absolute; margin-left: 85px;">
    ...
    <li><img class="image" border="0" src="wk.png"  width="55px" style=" margin-left: 40px; margin: 1px; padding: 0px color:white;"></li>
    </ul></b>
  </div>
</nav>
  ...
  <div class="p-2 flex-grow-1" style="margin-left: 150px; font-size: 20px;">
    ...
    <div class="p-2"><a href="#content1" style="text-decoration: none;">Beranda</a></div><hr>
    <div class="p-2"><a href="#content2" style="text-decoration: none;">Cara Wakaf</a></div><hr>
    <div class="p-2"><a href="#content3" style="text-decoration: none;">Data Wakaf</a></div><hr>
    <div class="p-2"><a href="#content4" style="text-decoration: none;">Gallery</a></div><hr>
    <div class="p-2"><a href="#content5" style="text-decoration: none;">Web Wikrama</a></div><hr>
  </div>
...
<div class="content1" id="content1">
    ...
    <img src="wk.png" style="position:absolute; margin-left:87%; height: 60px; width: 60px; margin-top: 13%;  background-color: #FFFFFF; border: 8.14286px solid #FFFFFF;
...
<div class="content2" id="content2">
  <div class="font">
      <div class="judul">
          <h1><span>Cara </span style="font-size: 30px;"><b>Wakaf, Infaq <br>
          Shodaqoh</b></h1>
      </div>
      <div class="deskripsi">
          <p>Berikut adalah beberapa Keutamaan Wakaf, Infaq
...
<footer class="footer">
  <div class="footer-img" style="display: flex;">
    <img src="wk.png" alt="" style="width: 45px; height: 45px; margin-top: 40px;">
